...
class CTMDataset(Dataset):
    ...
    def __init__(self, X_contextual, X_bow, idx2token, prior):
    ...
    def __getitem__(self, i):
        ...
        X_prior = torch.FloatTensor(self.prior[i])
        return_dict = {'X_bow': X_bow, 'X_contextual': X_contextual,'X_prior':X_prior}
